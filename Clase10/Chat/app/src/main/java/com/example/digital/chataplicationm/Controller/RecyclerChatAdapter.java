...
public class RecyclerChatAdapter extends RecyclerView.Adapter {
    ...
    public int getItemViewType(int position) {
        ...
        //El recycler nos da varios metedoso que nos sirve, es el 4 que nos sobreescribe si tiene distinto stipos de celdas. Logica de cuando tiene que usar uno y cuando tiene que usar otro
        ChatMessaje chatMessaje = chatMessajes.get(position);
